...
mat <- decostand(plants@otu_table, method = "hellinger")
dis <- vegdist(x = mat, method = "bray") # compute dissimilarity index
...
percent_explained <- 100 * ordmod$eig / sum(ordmod$eig) # store eigenvalues
...
mat <- decostand(pitrar@otu_table, method = "hellinger")
dis <- vegdist(x = mat, method = "bray") # compute dissimilarity index
...
mat <- decostand(nemrar@otu_table, method = "hellinger")
dis <- vegdist(x = nemrar@otu_table, method = "bray") # compute dissimilarity index
